...
var debug = require('debug')('{{slugcase name}}:parse-cmd');
...
module.exports = function() {
  ...
  if (cmd === '_main') {
    ...
    console.error('Unknown command "_main". See "{{slugcase name}} help" for available commands.');
    process.exit(1);
  }
  ...
  if (cmd === undefined) {
    ...
    try {
      ...
      console.error(format('Unknown command "%s". See "{{slugcase name}} help" for available commands.', cmd));
      process.exit(1);
    }
